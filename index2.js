...
console.log(typeof Number(n1)); //0
console.log(typeof Number(n1)); //123.9

console.log(Number(n1));
console.log(Number(n2));
console.log(Number(n3));
console.log(parseInt(n3)); //소수점은 버리고 정수형으로 변환

//let mathScore = "77";
//let engScore = "88";

//let avg = (${console.log(Number(mathScore))}; + ${console.log(Number(engScore))};) / 2;
